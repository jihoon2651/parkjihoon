	...
	<div id="galleryWrap" style="margin: 150px auto;">
		...
		<p>
			...
			<a href="#prev" onclick="prevGallery();"
				style="text-decoration: none;"> <img src="images/left_btn.png"
				alt="이전 그림" />
			</a>

			<!-- 원래는 공백없이 붙이면 가능함~(공백=데이터) 하지만 가독성을 해침-->
			<!-- <a href="#prev" onclick="prevGallery();" style="text-decoration: none;"><img src="images/left_btn.png" alt="이전 그림" /></a> -->

			<img src="images/img1.jpg" alt="갤러리 그림" id="gallery" /> <a
